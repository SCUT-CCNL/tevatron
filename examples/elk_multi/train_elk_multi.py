...
from tevatron.data import TrainDatasetForELK, QPCollatorForELK, TrainDatasetForELKMulti, QPCollatorForELKMulti
from tevatron.modeling import ELKModel, ELKMultiModel
from tevatron.trainer import ELKTrainer
from tevatron.datasets import HFTrainDataset, HFTrainDatasetWithCluster
...
def main():
    ...
    train_dataset = TrainDatasetForELKMulti(data_args, train_dataset.process(), tokenizer)
    if training_args.local_rank == 0:
    ...
    trainer = trainer_cls(
        ...
        data_collator=QPCollatorForELKMulti(
            tokenizer,
